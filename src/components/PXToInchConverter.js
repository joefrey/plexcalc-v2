...
const PxToInchConverter = () => {
  ...
  return (
    <div className="box-container-shadow">
      <TitleNav title="Pixels to Inches Converter" />
        ...
        <div className="flex justify-between space-x-7">
          ...
          <div className="relative">
            <div className="absolute bottom-[30px] -translate-x-1/2 left-1/2">
              <Link
                href={`/inch-to-px-converter/?inch=${inchValue}`}
...
export default PxToInchConverter;
