...
const RemToPx = () => {
  ...
  const remValueHandler = (event) => {
    ...
    if (!value) {
      ...
      current.set("rem", event.target.value);
    }
  ...
  return (
    <>
      <div className="box-container-shadow">
        <TitleNav title="REM to PX Converter" />
          ...
          <div className="mb-3">
            ...
            <div className="relative">
              ...
              <div className="pointer-events-none absolute inset-y-0 right-5 flex items-center pr-3">
                <span className="text-gray-400 sm:text-base">rem</span>
              </div>
            </div>
          </div>
          <div className="relative">
            <div className="absolute bottom-[30px] -translate-x-1/2 left-1/2">
              <Link
                href={`/px-to-rem-converter/?px=${pxValue}`}
